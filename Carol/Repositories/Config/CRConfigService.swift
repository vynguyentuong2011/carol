...
class CRConfigService: CRConfigServiceType {
    ...
    func getOnboardingConfig() -> Observable<[OnboardingItem]> {
        return Observable<[OnboardingItem]>.just([
            ...
            OnboardingItem(title: "Schedule your working time", image: "illustration", description: "Free courses for you to find your way to learning", index: 1),
            OnboardingItem(title: "Schedule your working time", image: "illustration", description: "Free courses for you to find your way to learning", index: 2)
        ])
    }
}
